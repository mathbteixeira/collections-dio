...
public class ExercicioProposto01 {
    public static void main(String[] args) {
        ...
        coresArcoIris.stream().filter(cor -> cor.startsWith("v")).forEach(System.out::println);

        System.out.println("Remova todas as cores que não começam com a letra “v”: ");
        coresArcoIris.removeAll(coresArcoIris.stream().filter(cor -> !cor.startsWith("v")).collect(Collectors.toSet()));
        System.out.println(coresArcoIris);
