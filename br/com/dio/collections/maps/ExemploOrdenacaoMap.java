...
public class ExemploOrdenacaoMap {
    public static void main(String[] args) {
        ...
        meusLivros1.forEach((key, value) -> System.out.println(key + " - " + value.getNome()));
        ...
        meusLivros3.forEach(l -> System.out.println(l.getKey() + " - " + l.getValue().getNome()));
        ...
        meusLivros4.forEach(l -> System.out.println(l.getKey() + " - " + l.getValue().getNome() + " - " + l.getValue().getPaginas()));
    }
}
